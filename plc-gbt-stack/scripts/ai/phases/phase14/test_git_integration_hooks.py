...
from git_integration_hooks import GitOptimizationHooks, StagingAnalysis
...
def test_basic_functionality():
    ...
    try:
        ...
        print(f"✅ GitOptimizationHooks initialized successfully")
...
def test_git_repository_validation():
    ...
    try:
        ...
        print(f"✅ Git repository validation completed")
...
def test_staged_change_analysis():
    ...
    try:
        ...
        print(f"✅ Staged change analysis completed")
...
def test_hook_content_generation():
    ...
    try:
        ...
        print(f"✅ Pre-commit hook content generated")
        ...
        print(f"✅ Pre-push hook content generated")
...
def test_hook_installation_simulation():
    ...
    try:
        ...
        print(f"✅ Hook installation simulation completed")
        print(f"   Hooks directory: {hooks.hooks_dir}")
...
def test_safety_score_calculation():
    ...
    try:
        ...
        print(f"✅ Safety score calculation completed")
...
def test_git_command_availability():
    ...
    try:
        ...
        if result.returncode == 0:
            print(f"✅ Git command available")
            print(f"   Version: {result.stdout.strip()}")
        else:
            print(f"⚠️  Git command not available")
        ...
        try:
            ...
            print(f"⚠️  Git repository check failed")
