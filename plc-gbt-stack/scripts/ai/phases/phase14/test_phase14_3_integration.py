...
from schema_registry import SchemaRegistry, SchemaDefinition, ValidationResult
from compliance_engine import ComplianceEngine, JSONUsage, SchemaViolation, ComplianceReport
from multi_db_schema_integration import MultiDBSchemaIntegration, SyncResult, ConsistencyReport
...
"""
    ...
    def test_03_compliance_engine_scanning(self):
        ...
        usage_types = set(usage.usage_type for usage in scan_results)
    ...
    def test_04_compliance_engine_violation_detection(self):
        ...
        violation_types = set(v.violation_type for v in compliance_report.violations)
