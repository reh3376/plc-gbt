    ...
    async def _run_safety_tests(self) -> List[TestResult]:
        ...
        try:
            ...
            try:
                ...
                TuningAlgorithms.ziegler_nichols_open_loop(invalid_model, ControllerType.PID)
            ...
            try:
                ...
                TuningAlgorithms.cohen_coon(invalid_model, ControllerType.PID)
            ...
            try:
                ...
                TuningAlgorithms.ziegler_nichols_open_loop(edge_case_model, ControllerType.PID)
