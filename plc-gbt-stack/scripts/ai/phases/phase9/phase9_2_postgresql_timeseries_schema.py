...
try:
    from scripts.ai.phases.phase9.phase9_1_mpc_controller_implementation import MPCState, ModelPredictiveController
    from scripts.ai.phases.phase9.phase9_1_ml_integration_fallback import MLPrediction, MLControlIntegration
