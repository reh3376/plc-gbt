...
from modules.integration import (
    ServiceManager, WolframAlphaProClient, OpenAIClient, ServiceType, 
    ServiceStatus, create_service_manager_with_defaults, ServiceContext
)
from modules.metrics import MetricCalculator, MetricType, PerformanceClassifier
from modules.data import DataLoader, DataValidator, DataPreprocessor
from modules.analysis import PerformanceAnalyzer, ReportGenerator, AnalysisResult

# Import existing Phase 13 components
from .phase13_1_wolfram_api_client import WolframQueryType, WolframResponse
from .phase13_2_mathematical_validator import (
    MathematicalValidator, ValidationRequest, ValidationResult,
    ValidationCategory, ControlSystemType, ValidationLevel
)
        ...
        for claim in claims:
            if claim.claim_id in validation_results:
                ...
                analysis_data = {
                    ...
                    "validation_result": result.validated,
