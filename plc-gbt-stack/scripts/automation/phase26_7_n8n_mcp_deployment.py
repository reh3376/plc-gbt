        ...
        try:
            ...
            if results['overall_success']:
                if args.validate_only:
                    ...
                    print("📍 n8n-MCP Endpoint: http://127.0.0.1:3000")
                    print("📍 n8n Endpoint: http://127.0.0.1:5678")
                    print("🔧 Run validation: python scripts/validation/phase26_7_n8n_mcp_integration_validation.py")
            else:
                print(f"\n❌ {'VALIDATION' if args.validate_only else 'DEPLOYMENT'} FAILED")
                print("Check logs and results for details")
