...
def generate_comprehensive_report(plc_files, validation_results, conversion_results, batch_results):
    ...
    report = {
        ...
        'test_summary': {
            ...
            'repositories_tested': len(set(f['repository'] for f in plc_files)),
...
def main():
    ...
    try:
        ...
        print(f"Found and tested {len(plc_files)} PLC files across {len(set(f['repository'] for f in plc_files))} repositories")
