/**
 * Quadratic Programming Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Quadratic Programming node
...
const QUADRATIC_PROGRAMMING_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Quadratic Programming implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Quadratic Programming 1",
  ...
  "examples": [
    {
      "title": "Basic Quadratic Programming Configuration",
      "description": "Simple configuration example for Quadratic Programming node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"quadratic-programming\",\n  \"config\": {\n    \"label\": \"Quadratic Programming Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function QuadraticProgrammingDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={QUADRATIC_PROGRAMMING_DATA} />;
}