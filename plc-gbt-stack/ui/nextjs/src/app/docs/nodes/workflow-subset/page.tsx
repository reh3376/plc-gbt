/**
 * Workflow Subset Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Workflow Subset node
...
const WORKFLOW_SUBSET_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Workflow Subset implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Workflow Subset 1",
  ...
  "examples": [
    {
      "title": "Basic Workflow Subset Configuration",
      "description": "Simple configuration example for Workflow Subset node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"workflow-subset\",\n  \"config\": {\n    \"label\": \"Workflow Subset Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function WorkflowSubsetDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={WORKFLOW_SUBSET_DATA} />;
}