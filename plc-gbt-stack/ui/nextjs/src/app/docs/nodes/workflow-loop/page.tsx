/**
 * Workflow Loop Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Workflow Loop node
...
const WORKFLOW_LOOP_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Workflow Loop implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Workflow Loop Configuration",
      "description": "Simple configuration example for Workflow Loop node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"workflow-loop\",\n  \"config\": {\n    \"label\": \"Workflow Loop Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function WorkflowLoopDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={WORKFLOW_LOOP_DATA} />;
}