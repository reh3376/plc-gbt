/**
 * Kpi Calculator Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Kpi Calculator node
...
const KPI_CALCULATOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Kpi Calculator implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Kpi Calculator Configuration",
      "description": "Simple configuration example for Kpi Calculator node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"kpi-calculator\",\n  \"config\": {\n    \"label\": \"Kpi Calculator Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function KpiCalculatorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={KPI_CALCULATOR_DATA} />;
}