/**
 * Time Series Processor Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Time Series Processor node
...
const TIME_SERIES_PROCESSOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Time Series Processor implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Time Series Processor 1",
  ...
  "examples": [
    {
      "title": "Basic Time Series Processor Configuration",
      "description": "Simple configuration example for Time Series Processor node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"time-series-processor\",\n  \"config\": {\n    \"label\": \"Time Series Processor Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function TimeSeriesProcessorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={TIME_SERIES_PROCESSOR_DATA} />;
}