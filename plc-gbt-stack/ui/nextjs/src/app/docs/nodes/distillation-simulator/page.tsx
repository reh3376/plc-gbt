/**
 * Distillation Simulator Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Distillation Simulator node
...
const DISTILLATION_SIMULATOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Distillation Simulator implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Distillation Simulator 1",
  ...
  "examples": [
    {
      "title": "Basic Distillation Simulator Configuration",
      "description": "Simple configuration example for Distillation Simulator node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"distillation-simulator\",\n  \"config\": {\n    \"label\": \"Distillation Simulator Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function DistillationSimulatorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={DISTILLATION_SIMULATOR_DATA} />;
}