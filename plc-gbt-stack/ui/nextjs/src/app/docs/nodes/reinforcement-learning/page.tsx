/**
 * Reinforcement Learning Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Reinforcement Learning node
...
const REINFORCEMENT_LEARNING_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Reinforcement Learning implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Reinforcement Learning 1",
  ...
  "examples": [
    {
      "title": "Basic Reinforcement Learning Configuration",
      "description": "Simple configuration example for Reinforcement Learning node",
      "language": "json",
...
export default function ReinforcementLearningDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={REINFORCEMENT_LEARNING_DATA} />;
}