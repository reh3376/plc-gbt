/**
 * Historian Connector Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Historian Connector node
...
const HISTORIAN_CONNECTOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Historian Connector implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Historian Connector 1",
  ...
  "examples": [
    {
      "title": "Basic Historian Connector Configuration",
      "description": "Simple configuration example for Historian Connector node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"historian-connector\",\n  \"config\": {\n    \"label\": \"Historian Connector Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function HistorianConnectorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={HISTORIAN_CONNECTOR_DATA} />;
}