/**
 * Qdrant Connector Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Qdrant Connector node
...
const QDRANT_CONNECTOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Qdrant Connector implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Qdrant Connector 1",
  ...
  "examples": [
    {
      "title": "Basic Qdrant Connector Configuration",
      "description": "Simple configuration example for Qdrant Connector node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"qdrant-connector\",\n  \"config\": {\n    \"label\": \"Qdrant Connector Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function QdrantConnectorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={QDRANT_CONNECTOR_DATA} />;
}