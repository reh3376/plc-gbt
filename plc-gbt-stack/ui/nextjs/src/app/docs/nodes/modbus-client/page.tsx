/**
 * Modbus Client Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Modbus Client node
...
const MODBUS_CLIENT_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Modbus Client implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Modbus Client Configuration",
      "description": "Simple configuration example for Modbus Client node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"modbus-client\",\n  \"config\": {\n    \"label\": \"Modbus Client Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function ModbusClientDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={MODBUS_CLIENT_DATA} />;
}