/**
 * Postgresql Connector Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Postgresql Connector node
...
const POSTGRESQL_CONNECTOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Postgresql Connector implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Postgresql Connector 1",
  ...
  "examples": [
    {
      "title": "Basic Postgresql Connector Configuration",
      "description": "Simple configuration example for Postgresql Connector node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"postgresql-connector\",\n  \"config\": {\n    \"label\": \"Postgresql Connector Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function PostgresqlConnectorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={POSTGRESQL_CONNECTOR_DATA} />;
}