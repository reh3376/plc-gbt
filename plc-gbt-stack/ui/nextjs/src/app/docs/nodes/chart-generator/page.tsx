/**
 * Chart Generator Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Chart Generator node
...
const CHART_GENERATOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Chart Generator implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Chart Generator 1",
  ...
  "examples": [
    {
      "title": "Basic Chart Generator Configuration",
      "description": "Simple configuration example for Chart Generator node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"chart-generator\",\n  \"config\": {\n    \"label\": \"Chart Generator Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function ChartGeneratorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={CHART_GENERATOR_DATA} />;
}