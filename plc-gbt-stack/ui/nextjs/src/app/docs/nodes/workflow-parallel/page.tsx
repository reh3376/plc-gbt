/**
 * Workflow Parallel Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Workflow Parallel node
...
const WORKFLOW_PARALLEL_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Workflow Parallel implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Workflow Parallel 1",
  ...
  "examples": [
    {
      "title": "Basic Workflow Parallel Configuration",
      "description": "Simple configuration example for Workflow Parallel node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"workflow-parallel\",\n  \"config\": {\n    \"label\": \"Workflow Parallel Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function WorkflowParallelDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={WORKFLOW_PARALLEL_DATA} />;
}