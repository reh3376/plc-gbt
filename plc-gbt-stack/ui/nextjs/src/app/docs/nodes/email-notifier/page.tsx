/**
 * Email Notifier Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Email Notifier node
...
const EMAIL_NOTIFIER_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Email Notifier implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Email Notifier Configuration",
      "description": "Simple configuration example for Email Notifier node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"email-notifier\",\n  \"config\": {\n    \"label\": \"Email Notifier Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function EmailNotifierDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={EMAIL_NOTIFIER_DATA} />;
}