/**
 * Prbs Generator Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Prbs Generator node
...
const PRBS_GENERATOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Prbs Generator implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Prbs Generator Configuration",
      "description": "Simple configuration example for Prbs Generator node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"prbs-generator\",\n  \"config\": {\n    \"label\": \"Prbs Generator Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function PrbsGeneratorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={PRBS_GENERATOR_DATA} />;
}