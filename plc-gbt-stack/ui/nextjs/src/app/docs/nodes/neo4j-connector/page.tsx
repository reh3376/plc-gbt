/**
 * Neo4j Connector Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Neo4j Connector node
...
const NEO4J_CONNECTOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Neo4j Connector implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Neo4j Connector 1",
  ...
  "examples": [
    {
      "title": "Basic Neo4j Connector Configuration",
      "description": "Simple configuration example for Neo4j Connector node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"neo4j-connector\",\n  \"config\": {\n    \"label\": \"Neo4j Connector Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function Neo4jConnectorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={NEO4J_CONNECTOR_DATA} />;
}