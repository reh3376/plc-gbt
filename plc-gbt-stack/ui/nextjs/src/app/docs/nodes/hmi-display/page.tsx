/**
 * Hmi Display Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Hmi Display node
...
const HMI_DISPLAY_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Hmi Display implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Hmi Display Configuration",
      "description": "Simple configuration example for Hmi Display node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"hmi-display\",\n  \"config\": {\n    \"label\": \"Hmi Display Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function HmiDisplayDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={HMI_DISPLAY_DATA} />;
}