/**
 * Url Display Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Url Display node
...
const URL_DISPLAY_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Url Display implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Url Display Configuration",
      "description": "Simple configuration example for Url Display node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"url-display\",\n  \"config\": {\n    \"label\": \"Url Display Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function UrlDisplayDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={URL_DISPLAY_DATA} />;
}