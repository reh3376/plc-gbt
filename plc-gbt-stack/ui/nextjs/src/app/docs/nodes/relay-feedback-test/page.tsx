/**
 * Relay Feedback Test Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Relay Feedback Test node
...
const RELAY_FEEDBACK_TEST_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Relay Feedback Test implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Relay Feedback Test 1",
  ...
  "examples": [
    {
      "title": "Basic Relay Feedback Test Configuration",
      "description": "Simple configuration example for Relay Feedback Test node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"relay-feedback-test\",\n  \"config\": {\n    \"label\": \"Relay Feedback Test Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function RelayFeedbackTestDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={RELAY_FEEDBACK_TEST_DATA} />;
}