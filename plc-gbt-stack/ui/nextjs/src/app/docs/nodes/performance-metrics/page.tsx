/**
 * Performance Metrics Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Performance Metrics node
...
const PERFORMANCE_METRICS_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Performance Metrics implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Performance Metrics 1",
  ...
  "examples": [
    {
      "title": "Basic Performance Metrics Configuration",
      "description": "Simple configuration example for Performance Metrics node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"performance-metrics\",\n  \"config\": {\n    \"label\": \"Performance Metrics Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function PerformanceMetricsDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={PERFORMANCE_METRICS_DATA} />;
}