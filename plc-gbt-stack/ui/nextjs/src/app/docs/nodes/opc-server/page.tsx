/**
 * Opc Server Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Opc Server node
...
const OPC_SERVER_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Opc Server implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Opc Server Configuration",
      "description": "Simple configuration example for Opc Server node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"opc-server\",\n  \"config\": {\n    \"label\": \"Opc Server Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function OpcServerDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={OPC_SERVER_DATA} />;
}