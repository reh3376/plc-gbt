/**
 * N8n Workflow Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for N8n Workflow node
...
const N8N_WORKFLOW_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "N8n Workflow implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic N8n Workflow Configuration",
      "description": "Simple configuration example for N8n Workflow node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"n8n-workflow\",\n  \"config\": {\n    \"label\": \"N8n Workflow Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function N8nWorkflowDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={N8N_WORKFLOW_DATA} />;
}