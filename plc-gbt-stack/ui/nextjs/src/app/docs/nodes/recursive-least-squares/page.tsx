/**
 * Recursive Least Squares Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Recursive Least Squares node
...
const RECURSIVE_LEAST_SQUARES_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Recursive Least Squares implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Recursive Least Squares 1",
  ...
  "examples": [
    {
      "title": "Basic Recursive Least Squares Configuration",
      "description": "Simple configuration example for Recursive Least Squares node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"recursive-least-squares\",\n  \"config\": {\n    \"label\": \"Recursive Least Squares Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function RecursiveLeastSquaresDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={RECURSIVE_LEAST_SQUARES_DATA} />;
}