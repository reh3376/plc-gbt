/**
 * Workflow Reference Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Workflow Reference node
...
const WORKFLOW_REFERENCE_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Workflow Reference implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Workflow Reference 1",
  ...
  "examples": [
    {
      "title": "Basic Workflow Reference Configuration",
      "description": "Simple configuration example for Workflow Reference node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"workflow-reference\",\n  \"config\": {\n    \"label\": \"Workflow Reference Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function WorkflowReferenceDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={WORKFLOW_REFERENCE_DATA} />;
}