/**
 * Data Logger Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Data Logger node
...
const DATA_LOGGER_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Data Logger implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Data Logger Configuration",
      "description": "Simple configuration example for Data Logger node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"data-logger\",\n  \"config\": {\n    \"label\": \"Data Logger Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function DataLoggerDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={DATA_LOGGER_DATA} />;
}