/**
 * Gaussian Process Regression Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Gaussian Process Regression node
...
const GAUSSIAN_PROCESS_REGRESSION_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Gaussian Process Regression implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Gaussian Process Regression 1",
  ...
  "examples": [
    {
      "title": "Basic Gaussian Process Regression Configuration",
      "description": "Simple configuration example for Gaussian Process Regression node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"gaussian-process-regression\",\n  \"config\": {\n    \"label\": \"Gaussian Process Regression Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function GaussianProcessRegressionDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={GAUSSIAN_PROCESS_REGRESSION_DATA} />;
}