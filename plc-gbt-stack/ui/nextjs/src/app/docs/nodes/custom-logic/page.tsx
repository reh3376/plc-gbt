/**
 * Custom Logic Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Custom Logic node
...
const CUSTOM_LOGIC_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Custom Logic implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Custom Logic Configuration",
      "description": "Simple configuration example for Custom Logic node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"custom-logic\",\n  \"config\": {\n    \"label\": \"Custom Logic Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function CustomLogicDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={CUSTOM_LOGIC_DATA} />;
}