/**
 * Data Cleaner Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Data Cleaner node
...
const DATA_CLEANER_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Data Cleaner implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Data Cleaner Configuration",
      "description": "Simple configuration example for Data Cleaner node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"data-cleaner\",\n  \"config\": {\n    \"label\": \"Data Cleaner Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function DataCleanerDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={DATA_CLEANER_DATA} />;
}