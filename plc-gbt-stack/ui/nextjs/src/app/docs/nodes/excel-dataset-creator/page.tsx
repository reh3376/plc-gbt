/**
 * Excel Dataset Creator Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Excel Dataset Creator node
...
const EXCEL_DATASET_CREATOR_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Excel Dataset Creator implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Excel Dataset Creator 1",
  ...
  "examples": [
    {
      "title": "Basic Excel Dataset Creator Configuration",
      "description": "Simple configuration example for Excel Dataset Creator node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"excel-dataset-creator\",\n  \"config\": {\n    \"label\": \"Excel Dataset Creator Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function ExcelDatasetCreatorDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={EXCEL_DATASET_CREATOR_DATA} />;
}