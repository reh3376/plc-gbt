/**
 * Workflow Conditional Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Workflow Conditional node
...
const WORKFLOW_CONDITIONAL_DATA: NodeDocumentationData = {
  "nodeType": "workflow-conditional",
  "title": "Workflow Conditional",
  "description": "Workflow Conditional node for industrial automation applications",
  "overview": "The Workflow Conditional node is part of the Workflow Management category and provides workflow conditional node for industrial automation applications. \n\nThis node is classified as moderate complexity and is primarily used for complex workflow automation and process management. It integrates seamlessly with other nodes in the System Components, Control & Optimization categories to provide comprehensive industrial automation solutions.\n\nKey capabilities include advanced configuration options, real-time monitoring, robust error handling, and extensive integration possibilities with other system components.",
  "features": [
  ...
  "useCases": [
    "Workflow Conditional implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Workflow Conditional 1",
  ...
  "examples": [
    {
      "title": "Basic Workflow Conditional Configuration",
      "description": "Simple configuration example for Workflow Conditional node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"workflow-conditional\",\n  \"config\": {\n    \"label\": \"Workflow Conditional Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function WorkflowConditionalDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={WORKFLOW_CONDITIONAL_DATA} />;
}