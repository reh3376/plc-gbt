/**
 * Narx Neural Network Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Narx Neural Network node
...
const NARX_NEURAL_NETWORK_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Narx Neural Network implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Narx Neural Network 1",
  ...
  "examples": [
    {
      "title": "Basic Narx Neural Network Configuration",
      "description": "Simple configuration example for Narx Neural Network node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"narx-neural-network\",\n  \"config\": {\n    \"label\": \"Narx Neural Network Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function NarxNeuralNetworkDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={NARX_NEURAL_NETWORK_DATA} />;
}