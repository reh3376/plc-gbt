/**
 * Alarm Handler Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Alarm Handler node
...
const ALARM_HANDLER_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Alarm Handler implementation in industrial processes",
  ...
  "examples": [
    {
      "title": "Basic Alarm Handler Configuration",
      "description": "Simple configuration example for Alarm Handler node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"alarm-handler\",\n  \"config\": {\n    \"label\": \"Alarm Handler Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function AlarmHandlerDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={ALARM_HANDLER_DATA} />;
}