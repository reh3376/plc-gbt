/**
 * Genetic Algorithm Documentation Page - AI Task Orchestrator TypeScript Implementation
 *
 * @description Comprehensive documentation for Genetic Algorithm node
...
const GENETIC_ALGORITHM_DATA: NodeDocumentationData = {
  ...
  "useCases": [
    "Genetic Algorithm implementation in industrial processes",
  ...
  "parameters": [
    {
      "name": "label",
      "type": "string",
      "defaultValue": "Genetic Algorithm 1",
  ...
  "examples": [
    {
      "title": "Basic Genetic Algorithm Configuration",
      "description": "Simple configuration example for Genetic Algorithm node",
      "language": "json",
      "code": "{\n  \"nodeType\": \"genetic-algorithm\",\n  \"config\": {\n    \"label\": \"Genetic Algorithm Example\",\n    \"enabled\": true\n  }\n}"
    }
  ],
  "troubleshooting": [
    {
...
export default function GeneticAlgorithmDocumentation(): React.JSX.Element {
  return <NodeDocumentationTemplate data={GENETIC_ALGORITHM_DATA} />;
}