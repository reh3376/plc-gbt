...
try:
    from ..framework.command_base import CLICommand, requires_permission, Permission
...
def clone_instance(source_instance_id, name, output):
    ...
    try:
        ...
        if success:
            console.print(f"✅ Instance cloned successfully!")
...
def update_instance(instance_id, name, description, status, set_params):
    ...
    try:
        ...
        if success:
            console.print(f"✅ Instance updated successfully!")
...
def import_instance(file_path, schema, name, force):
    ...
    try:
        ...
        try:
            ...
            if success:
                console.print(f"✅ Instance imported successfully!")
                console.print(f"Instance ID: [green]{instance.instance_id}[/green]")
...
def plc_connect(host, slot, timeout):
    ...
    try:
        ...
        if success:
            console.print(f"✅ Connected to PLC successfully!")
