...
from .confidence_scoring import ConfidenceScorer, OverallConfidence
from .statistical_tests import (
    StatisticalTestResult,
    StatisticalTestSuite,
    run_statistical_validation,
)
from .wolfram_integration import WolframValidationResult, WolframValidator
...
class ValidationManager:
    ...
    def _generate_summary(self,
        ...
        try:
            ...
            return "Validation summary generation failed"
    ...
    def get_validation_statistics(self) -> Dict[str, Any]:
        ...
        for _component, component_stats in stats['component_stats'].items():
