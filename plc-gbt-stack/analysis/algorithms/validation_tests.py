...
from .registry_manager import registry_manager, ExecutionResult
from . import registry, AlgorithmCategory
...
class AlgorithmRegistryValidator:
    ...
    def _generate_summary(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Algorithm summary
        for alg_name, result in results['algorithm_tests'].items():
            if result.success:
