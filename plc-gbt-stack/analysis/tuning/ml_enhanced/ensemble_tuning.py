...
try:
    from .neural_tuning import NeuralNetworkConfig, NeuralNetworkTuner
    NEURAL_AVAILABLE = True
except ImportError:
    NEURAL_AVAILABLE = False

try:
    from .transfer_tuning import TransferConfig, TransferLearningTuner
...
class EnsembleTuner:
    ...
    def _initialize_weights(self):
        ...
        if self.config.model_weights:
            ...
            self.model_weights = dict.fromkeys(self.base_models.keys(), equal_weight)
