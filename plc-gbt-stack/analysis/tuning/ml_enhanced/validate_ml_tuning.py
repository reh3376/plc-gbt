...
try:
    ...
    from plc_gbt_stack.analysis.tuning.ml_enhanced import (
        MLTuningManager, MLManagerConfig, MLMethodType,
        ML_TUNING_CONFIG, get_available_ml_methods,
        check_ml_dependencies, get_recommended_framework
    )
    ML_ENHANCED_AVAILABLE = True
except ImportError:
    try:
        # Try relative imports
        from ml_manager import MLTuningManager, MLManagerConfig
        from __init__ import (
            MLMethodType, ML_TUNING_CONFIG, get_available_ml_methods,
            check_ml_dependencies, get_recommended_framework
        )
        ML_ENHANCED_AVAILABLE = True
...
def main():
    ...
    try:
        ...
        print(f"📊 Available methods: mock_method")
