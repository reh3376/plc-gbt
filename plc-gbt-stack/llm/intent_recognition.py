...
from . import (
    IntentType, TaskComplexity, Intent, ApplicationContext,
    LLMRequest, LLMResponse, LLMRequestType, ConversationMessage, ConversationRole
)
    ...
    def classify_intent(self, text: str, entities: Dict[EntityType, List[ExtractedEntity]], 
        ...
        for intent_type, patterns in self.intent_patterns.items():
            ...
            if score > 0.1:  # Minimum threshold
                ...
                complexity = self._determine_complexity(text_lower, entities)
