...
class TestDataSyncEngine:
    ...
    async def test_sync_with_conflicts(self, sync_engine, mock_databases):
        ...
        target_data = {"value": 25.7, "timestamp": 1640995200.0}
...
class TestIntegrationScenarios:
    ...
    async def test_disaster_recovery_scenario(self):
        ...
        redis_data = [
            {"device_id": "PLC_001", "tag": "temperature", "value": 25.5, "timestamp": 1640995300.0},
            {"device_id": "PLC_002", "tag": "pressure", "value": 101.3, "timestamp": 1640995300.0}
        ]
        
        postgres_data = [
            {"device_id": "PLC_001", "tag": "temperature", "value": 25.2, "timestamp": 1640995200.0},
            # Missing PLC_002 data
        ]
