...
class InstallationWizard:
    ...
    def __init__(self):
        ...
        # Check for installer package environment
        if "AI_FRAMEWORK_DESTINATION" in os.environ:
            self.installation_path = Path(os.environ["AI_FRAMEWORK_DESTINATION"])
        else:
            self.installation_path = Path.cwd() / "ai_enhancement_framework"
        self.config_data = {}
        self.installer_root = Path(__file__).parent.parent  # installer package root
