                    ...
                    try:
                        ...
                        if lfs_pull_result.returncode == 0:
                            ...
                            if size_increase > 0.1:  # More than 100KB increase
                                ...
                                print(f"   ⚠️ No significant size increase detected")
                        else:
    ...
    <Tags Use="Context">
        <!-- Global tags would be extracted from ACD file -->
                                    ...
                                    try:
                                        ...
                                        print(f"   ⚠️ Validation warning (50%)")
